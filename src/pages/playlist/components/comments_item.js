    ...
    return (
      <div className='o-flag o-flag--small u-margin-top-large'>
        ...
        <div className='o-flag__body'>
          ...
          <p className='u-white-space-pre-line u-margin-top-tiny'><Linkify className='c-linkified' properties={{target: '_blank', rel: "nofollow" }}>{description}</Linkify></p>
          <div className='o-grid o-grid--auto o-grid--middle u-margin-top-tiny'>
            <div className='o-grid__cell'>
              <div className='o-flag o-flag--tiny'>
                <div className='o-flag__img'>
                  <button title='like' onClick={onVote(id, like_status, +1)} className={`c-btn c-btn--vote u-align-top ${youUpvoted ? 'is-active' : ''}`} disabled={!canVote}>
            ...
            <div className='o-grid__cell'>
              <div className='o-flag o-flag--tiny'>
                <div className='o-flag__img'>
                  <button title='dislike' onClick={onVote(id, like_status, -1)} className={`c-btn c-btn--vote ${youDownvoted ? 'is-active' : ''}`} disabled={!canVote}>
                    <svg width='14' height='14' viewBox='0 0 14 14' xmlns='http://www.w3.org/2000/svg'>
